...
url_label = Label(url_frame, text="URL:", font=normal_text)
...
dir_label = Label(dir_frame, text="Directory:", font=normal_text)
...
links_check = Checkbutton(check_frame, text="Links", variable=links_bool, onvalue=True, offvalue=False, font=normal_text)
links_check.pack(side=LEFT, padx=20)
images_check = Checkbutton(check_frame, text="Images", variable=images_bool, onvalue=True, offvalue=False, font=normal_text)
